...
DATABASES = {
    'default': {
        ...
        'NAME': 'sportbooking',                      # Or path to database file if using sqlite3.
        'USER': 'frryd',                      # Not used with sqlite3.
        'PASSWORD': 'VemVillInteHaliteRolIgtiblandeller',                  # Not used with sqlite3.
...
MEDIA_ROOT = '/home/oliver/sportbooking_frryd/media/'
...
AUTHENTICATION_BACKENDS = (
        ...
        # see https://bitbucket.org/cpcc/django-cas/overview
)

CAS_SERVER_URL = 'https://login.liu.se/cas/'

ROOT_URLCONF = 'sportbooking_frryd.urls'
