...
urlpatterns = patterns('',
    ...
    url(r'^copyright/$', 'booking.views.general.copyright', name='copyright'),
    url(r'^m/resource/(?P<resource_id>\d+)/$', 'booking.views.booking_calendar.resource', name='mobile_resource'),
